...
export default function Show({ auth, field }) {
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <div className="mb-6">
                                ...
                                <dl className="mt-2 grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <dd className="mt-1 text-sm text-gray-900">{field.description || 'N/A'}</dd>
                                    </div>
                                </dl>
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="mt-2">
                                    {field.modules && field.modules.length > 0 ? (
                                        <ul className="divide-y divide-gray-200">
